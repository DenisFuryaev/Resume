...
\renewcommand{\maketitle}{
    ...
    \href{mailto:denis.furiaev@parallels.com}{\faInbox \, Work: denis.furiaev@parallels.com} ---
...
\subsubsection{\includegraphics[height=0.7em]{parallels-logo.png} Parallels (Mauritius) Limited \hfill August 2022 - Current}
